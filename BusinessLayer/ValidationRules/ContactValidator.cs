...
namespace BusinessLayer.ValidationRules
{
    public class ContactValidator: AbstractValidator<Contact>
    {
        public ContactValidator()
        {
            ...
            RuleFor(x => x.Message).MinimumLength(10).WithMessage("Mesaj alanı minimum 10 karakter içermelidir");
            ...
            RuleFor(x => x.Subject).MinimumLength(4).WithMessage("Konu alanı minimum 4 karakterden oluşmalıdır");
